...
-- DOES NOT WORK hl.env("AQ_DRM_DEVICES", "/dev/dri/by-path/pci-0000:05:00.0-card:/dev/dri/by-path/pci-0000:01:00.0-card")
hl.env("XDG_MENU_PREFIX", "arch-")
hl.env(
    "XDG_DATA_DIRS",
    "/var/lib/flatpak/exports/share:/home/dog/.local/share/flatpak/exports/share:/usr/local/share:/usr/share"
)
-----------------------
----- PERMISSIONS -----
-----------------------
...
hl.curve("snapOut", { type = "bezier", points = { { 0.23, 1 }, { 0.32, 1 } } })
hl.curve("popIn", { type = "bezier", points = { { 0.05, 0.9 }, { 0.1, 1.05 } } })
hl.curve("linear", { type = "bezier", points = { { 0, 0 }, { 1, 1 } } })
hl.curve("bounce", { type = "spring", mass = 0.6, stiffness = 200, dampening = 18 })

-- Global fallback
hl.animation({ leaf = "global", enabled = true, speed = 12, bezier = "snap" })

-- Windows
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3, bezier = "popIn", style = "popin 80%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 12, bezier = "linear", style = "popin 80%" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 12, spring = "bounce" })

-- Borders
hl.animation({ leaf = "border", enabled = true, speed = 8, bezier = "snapOut" })
...
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 2.5, bezier = "snap" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 2, bezier = "snap" })

-- Workspaces
hl.animation({ leaf = "workspaces", enabled = true, speed = 3.5, bezier = "snapOut", style = "slide" })
hl.animation({ leaf = "layers", enabled = true, speed = 2.5, bezier = "snap", style = "fade" })
...
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("bash ~/dotfiles/scripts/screenshot.sh window"))
